...
## Contenido
- Este proyecto (actualmente en desarrollo) tiene una única rama, master.
...
Esta app requiere [Node.js](https://nodejs.org/en/) para ejecutarse.
...
3 - Escribe `git clone` y luego pega la siguiente URL `https://github.com/BrendaBernardi1/mi-e-commerce.git`
